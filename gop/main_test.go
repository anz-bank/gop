...
import (
	...
	cacher_fs "github.com/joshcarp/pb-mod/gop/cacher/cacher_fs"
	processor_sysl "github.com/joshcarp/pb-mod/gop/processor/processor_sysl"

	retriever_pbjsongit "github.com/joshcarp/pb-mod/gop/retriever/retriever_pbjsongit"
...
func TestGetRetrieveWithDeps(t *testing.T) {
	...
	a := config.AppConfig{
		CacheLocation: "/dev/null",
	}
	r := retriever_pbjsongit.Retriever{AppConfig: a}
	s := cacher_fs.Cacher{AppConfig: a}
	p := processor_sysl.Processor{}
	serve := Server{
		Retriever: r,
		Processor: &p,
		Cacher:    s,
	...
	banana := &pbmod.Object{Repo: "github.com/anz-bank/sysl", Version: "e78f4afc524ad8d1a1a4740779731d706b7b079b", Resource: "tests/bananatree.sysl", Processed: &pb, Content: "Bananatree [package=\"bananatree\"]:\n  !type Banana:\n    id \u003c: int\n    title \u003c: string\n\n  /banana:\n    /{id\u003c:int}:\n      GET:\n        return Banana\n\n  /morebanana:\n    /{id\u003c:int}:\n      GET:\n        return Banana\n"}
	require.Equal(t, *banana.Processed, *res.Processed)
	banana.Processed = nil
	res.Processed = nil
	require.NoError(t, err)
